...
##
## AK: TODO - clean up structure (secondary prio)
##
...
def print_info():
    ...
    api.send("info", "BK (2023-07-19): Also TIME datatype added")
...
def create_table(mydict):
    ...
    # Create .proto declaration
    proto = []
    proto.append('syntax = "proto2";')
    proto.append('')
    proto.append('message SampleData {')
    ...
    # Print the data for the <table>.proto file
    #print(*proto, sep='\n')
    for line in proto :
        api.send("info", line)
