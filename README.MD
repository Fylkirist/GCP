...
Checks if the table exists and creates it with the proper attributes if not, it can always be present in pipeline, but make sure it is ahead of the CDC writer.